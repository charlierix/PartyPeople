        ...
        private class VelocityTracker_Log
        {
            ...
            private void DrawLinear()
            {
                ...
                else
                {
                    try
                    {
                        ITriangle_wpf plane = Math2D.GetPlane_Average(_velocityHistory.Select(o => o.delta.ToPoint()).ToArray());
                        offset = plane.Normal;
                    }
                    catch (Exception)
                    {
            ...
            private void DrawOrbit()
            {
                ...
                else
                {
                    try
                    {
                        ITriangle_wpf plane = Math2D.GetPlane_Average(axisAngles.Select(o => o.axis.ToPoint()).ToArray());
                        offset = plane.Normal;
                    }
                    catch (Exception)
                    {
