...
namespace Game.Math_WPF.Mathematics
{
    ...
    /// </summary>
    /// <remarks>
    /// If you want to visualize the tetrahedron that was used when coming up with edges and faces:
    ///     1,2,3 are the base in counter clockwise order
    ///     0 is the tip of the pyramid
    /// </remarks>
    public class Tetrahedron_wpf : IComparable<Tetrahedron_wpf>
    {
        ...
        public Tetrahedron_wpf(int index0, int index1, int index2, int index3, Point3D[] allPoints)
            : this(index0, index1, index2, index3, allPoints, new SortedList<Tuple<int, int, int>, TriangleIndexedLinked_wpf>())
        {
        }
        ...
        /// </param>
        public Tetrahedron_wpf(int index0, int index1, int index2, int index3, Point3D[] allPoints, SortedList<Tuple<int, int, int>, TriangleIndexedLinked_wpf> buildingTriangles)
        {
            this.Index0 = index0;
            this.Index1 = index1;
            this.Index2 = index2;
        ...
        /// </summary>
        public int CompareTo(Tetrahedron_wpf other)
        {
            if (other == null)
            {
        ...
        public readonly TriangleIndexedLinked_wpf Face_012;
        public readonly TriangleIndexedLinked_wpf Face_023;
        public readonly TriangleIndexedLinked_wpf Face_031;
        public readonly TriangleIndexedLinked_wpf Face_132;     // think of this as the base of the pyramid (if that helps)

        private TriangleIndexedLinked_wpf[] _faceArray = null;
        /// <summary>
        /// NOTE:  This is readonly - any changes to this array won't be reflected by this class
        /// </summary>
        public TriangleIndexedLinked_wpf[] FaceArray
        {
            get
            {
                lock (_lock)
        ...
        private Tetrahedron_wpf _neighbor_012 = null;
        public Tetrahedron_wpf Neighbor_012
        {
            get
            {
                lock (_lock)
        ...
        private Tetrahedron_wpf _neighbor_023 = null;
        public Tetrahedron_wpf Neighbor_023
        {
            get
            {
                lock (_lock)
        ...
        private Tetrahedron_wpf _neighbor_031 = null;
        public Tetrahedron_wpf Neighbor_031
        {
            get
            {
                lock (_lock)
        ...
        private Tetrahedron_wpf _neighbor_132 = null;
        public Tetrahedron_wpf Neighbor_132
        {
            get
            {
                lock (_lock)
        ...
        public TriangleIndexedLinked_wpf GetFace(TetrahedronFace face)
        {
            switch (face)
            {
                case TetrahedronFace.Face_012:
        ...
        public Tetrahedron_wpf GetNeighbor(TetrahedronFace face)
        {
            switch (face)
            {
                case TetrahedronFace.Face_012:
        ...
        public void SetNeighbor(TetrahedronFace face, Tetrahedron_wpf neighbor)
        {
            switch (face)
            {
                case TetrahedronFace.Face_012:
        ...
        /// </summary>
        public void SetNeighbor(Tetrahedron_wpf neighbor)
        {
        ...
        public TetrahedronFace WhichFace(Tetrahedron_wpf neighbor)
        {
        ...
        /// </remarks>
        public static void LinkTetrahedrons(IEnumerable<Tetrahedron_wpf> tetrahedrons, bool setNullIfNoLink)
        {
            foreach (Tetrahedron_wpf tetra in tetrahedrons)
            {
                long currentToken = tetra.Token;

                foreach (TetrahedronFace face in Tetrahedron_wpf.Faces)
                {
                    ...
                    Tetrahedron_wpf neighbor = tetrahedrons.FirstOrDefault(o => o.Token != currentToken && o.FaceArray.Any(p => p.IsMatch(indicesSorted)));
        ...
        /// </summary>
        public static Tuple<int, int>[] GetUniqueLines(IEnumerable<Tetrahedron_wpf> tetrahedrons)
        {
        ...
        public static TriangleIndexed_wpf[] GetUniqueTriangles(Tetrahedron_wpf[] tetras)
        {
            return tetras.
        ...
        private static TriangleIndexedLinked_wpf FindOrCreateTriangle(int index0, int index1, int index2, Point3D[] allPoints, SortedList<Tuple<int, int, int>, TriangleIndexedLinked_wpf> buildingTriangles)
        {
            ...
            TriangleIndexedLinked_wpf retVal;
            if (!buildingTriangles.TryGetValue(key, out retVal))
            {
                retVal = new TriangleIndexedLinked_wpf(index0, index1, index2, allPoints);
