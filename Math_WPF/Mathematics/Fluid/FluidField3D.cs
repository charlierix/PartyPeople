...
namespace Game.Math_WPF.Mathematics.Fluid
{
    ...
    public class FluidField3D
    {
        ...
        /// </param>
        public Rectangle3DIndexedMapped_wpf[] GetCells(bool shouldTransform = false)
        {
            return GetCells(this.SizeWorld);
        }
        public Rectangle3DIndexedMapped_wpf[] GetCells(double rectangleSize, bool shouldTransform = false)
        {
            ...
            // Cells
            var retVal = new Rectangle3DIndexedMapped_wpf[_size1D];
            ...
            for (int x = 0; x < _size; x++)
            {
                for (int y = 0; y < _size; y++)
                {
                    ...
                    {
                        int index = Get1DIndex(x, y, z);
                        retVal[index] = new Rectangle3DIndexedMapped_wpf(new Mapping_3D_1D(x, y, z, index), cornerPoints, new int[]
                            {
