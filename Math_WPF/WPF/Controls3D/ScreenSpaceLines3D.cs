...
namespace Game.Math_WPF.WPF.Controls3D
{
    ...
    public class ScreenSpaceLines3D : ModelVisual3D, ISupportInitialize, IDisposable
    {
        ...
        public void MakeWireframe(Model3D model)
        {
            ...
            var transform = new MathUtils.Matrix3DStack();
        ...
        private void WireframeHelper(Model3D model, MathUtils.Matrix3DStack matrixStack)
        {
            BeginInit();
        ...
        private void WireframeHelper(Model3DGroup group, MathUtils.Matrix3DStack matrixStack)
        {
            BeginInit();
        ...
        private void WireframeHelper(GeometryModel3D model, MathUtils.Matrix3DStack matrixStack)
        {
