...
namespace Accord.Collections
{
    ...
    /// 
    [Serializable]
    public class VPTree_Custom<TPoint> : VPTreeBase_Custom<TPoint, VPTreeNode_Custom<TPoint>>
    {
        /// <summary>
        ...
        /// 
        public static VPTree_Custom<TPoint> FromData(TPoint[] points, IDistance<TPoint> distance, IDistance<TPoint> distance_quick, bool inPlace = false)
        {
            var tree = new VPTree_Custom<TPoint>(distance, distance_quick);
